...
import { User, Mail, Phone, Lock, ChevronDown, ChevronUp, ChevronRight } from "lucide-react"
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6">
            <div className="w-full max-w-md">
                ...
                <form onSubmit={handleRegister} className="flex flex-col space-y-4">
                    ...
                    <div className="flex items-start space-x-2 text-xs sm:text-sm text-gray-600 leading-snug">
                        <input
                            type="checkbox"
                            name="agree"
                            checked={form.agree}
                    ...
                    <button
                        type="submit"
                        className="w-full bg-[#103051] text-white rounded-full py-3 sm:py-4 font-medium hover:bg-[#0c243d] transition text-sm sm:text-base cursor-pointer"
                    >
                        Daftar
                    </button>
                </form>
